...
import com.codeworld.fc.role.client.MenuClient;
...
import com.codeworld.fc.role.mapper.RoleMapper;
...
public class RoleServiceImpl implements RoleService {
    ...
    public FCResponse<Void> addRoleMenu(RoleMenuRequest roleMenuRequest) {
        try {
            ...
            // 先删除角色的菜单
            this.menuClient.deleteRoleMenuByRoleId(roleMenuRequest.getRoleId());
            ...
            for (RoleMenu roleMenu : roleMenus
                ...
                this.menuClient.addRoleMenu(roleMenu);
            }
...
//            this.roleMapper.deleteUserRoleByRoleId(roleId);
            // 删除角色关联的菜单
            this.menuClient.deleteRoleMenuByRoleId(roleId);
            // 删除角色信息
